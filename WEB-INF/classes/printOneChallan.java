...
public class printOneChallan extends HttpServlet{
    ...
    throws IOException,ServletException
    {
        ...
        try{
            ...
            String query="select * from studentinfo where roll='"+roll1+"'";
            ResultSet rs = st.executeQuery( query );
            out.println("<html><head><title>Challan Form</title></head><body style='width:1600px; background: white;'>");
            ...
            if(rs.next()){
                ...
                out.println("<table style='border-width:0px; margin-left:10px; margin-top:10px; border-spacing: 20px;'>"+
                    "<tr>"+
                        "<td>"+
